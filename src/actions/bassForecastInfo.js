...
export const fetchSelectedCityForecast = ({lat, lng, tz, day, month, year}) => {
    return(dispatch) => {
        return axios({
            method: "get",
        ...
        .catch(( e ) => {
            ...
            dispatch(setErrorState({
                isOpen : true,
                errorMessage : "Fetching selected city forecast failed with an error",
                error : e.message,
                errorType : "Blocker"
            }));
        });
...
export const fetchBFR = (postalCode, locationKey, stationCode) => {
    return(dispatch) => {
        ...
        .catch(( e ) => {
            ...
            dispatch(setErrorState({
                isOpen : true,
                errorMessage : "Fetching BassForecast Rating has failed with an error",
                error : e.message,
                errorType : "BFR"
            }));
        });
